...
public class EliminarVendedor extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     public void buscar(){
        ...
        for(int i=0;i<this.ventanaMenu.listaVendedores.length;i++){
            if(this.ventanaMenu.listaVendedores[i]!=null &&  this.ventanaMenu.listaVendedores[i].getCedula().equals(buscar)){
                this.MostrarDatos.setText(this.ventanaMenu.listaVendedores[i].getNombre()+"-"+this.ventanaMenu.listaVendedores[i].getApellidos());
            }
        }
    }
    ...
    private void eliminar(){
        ...
        for(int i=0;i<this.ventanaMenu.listaVendedores.length;i++){
            if(this.ventanaMenu.listaVendedores[i]!=null &&  this.ventanaMenu.listaVendedores[i].getCedula().equals(buscar)){
                int posicion=i;
                for(int j=posicion;j<this.ventanaMenu.listaVendedores.length-1;j++){
