...
public class MostrarVendedor extends javax.swing.JFrame {
    ...
    Menu ventanaMenu;
    public MostrarVendedor(Menu ventanamenu) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mostrar Vendedores");
    ...
    private void mostrarVendedor(){
        for(int i=0;i<this.ventanaMenu.listaVendedores.length;i++){
            if(this.ventanaMenu.listaVendedores[i]!=null){
                String nombre = this.ventanaMenu.listaVendedores[i].getNombre();
                String apellido = this.ventanaMenu.listaVendedores[i].getApellidos();
                String telefono = this.ventanaMenu.listaVendedores[i].getTelefono();
                String cedula =this.ventanaMenu.listaVendedores[i].getCedula();
                String mostrar = nombre+"--"+apellido+"--"+telefono+"--"+cedula+"\n";
                MostrarTodo.append(mostrar);
            }
        }
    }
