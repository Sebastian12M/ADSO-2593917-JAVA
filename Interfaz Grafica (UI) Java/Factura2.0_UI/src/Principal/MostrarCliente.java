...
public class MostrarCliente extends javax.swing.JFrame {
    ...
    Menu ventanaMenu;
    public MostrarCliente(Menu ventanaMenu) {
    ...
    private void initComponents() {
        ...
        MostrarTodo.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
    ...
    private void mostrarCliente(){
        for(int i=0;i<this.ventanaMenu.listaPersonas.length;i++){
            if(this.ventanaMenu.listaPersonas[i]!=null){
                ...
                String apellido = this.ventanaMenu.listaPersonas[i].getApellidos();
                ...
                String mostrar = nombre+"--"+apellido+"--"+telefono+"--"+direccion+"--"+cedula+"\n";
