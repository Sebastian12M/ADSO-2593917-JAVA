...
public class CrearFactura extends JFrame{
    ...
    public void initComponent(){
        ...
        */
        ...
        ActionListener evento_agregar = (ActionEvent e) -> {
          int cantidad_producto=Integer.parseInt(input_cant_producto.getText());
            String nombre_de_producto=input_nombre_producto.getText();
            String id_producto=input_id_producto.getText();
            String id_factura=this.ventanaMenu.database.extraerId();
            String cantidad_string=String.valueOf(cantidad_producto);
            Producto producto=this.ventanaMenu.database.buscarProducto(id_producto);
            int precio= producto.getPrecio();
            int subtotal=precio*cantidad_producto;
            total=total+subtotal;
            String poner_text=nombre_de_producto+"---"+cantidad_producto+"---"+subtotal;
            
             
            Factura_producto temporal=new Factura_producto(id_factura,id_producto, cantidad_string, subtotal);
            ...
            this.productos[i]=temporal;
            i++;
            

        };
        btn_add_producto.addActionListener(evento_agregar);  
            
        
        
        ActionListener evento_registrar = (ActionEvent e) -> {
            
            String cedula_ven=input_cedula_vendedor.getText();
            String cedula_clien=input_cedula_cliente.getText();
    ...
    public void buscarCliente(){
        ...
        Persona per = null;
        per=this.ventanaMenu.database.buscarCliente(texto);
        
        if(per!=null){
            this.input_nombres_cliente.setText( per.getNombres() );
            this.input_direccion_cliente.setText( per.getDireccion() );
            encontrado = true;
    ...
    public void buscarVendedor(){
        String texto = input_cedula_vendedor.getText();
        boolean encontrado = false;
        Persona per = this.ventanaMenu.database.buscarVendedor(texto);
        
        if(per!=null){
            this.input_nombres_vendedor.setText( per.getNombres() );
            encontrado = true;
    ...
    public void buscarProducto(){
        String texto = input_id_producto.getText();
        boolean encontrado = false;
        Producto pro = this.ventanaMenu.database.buscarProducto(texto);
            
                if(pro!=null){
                    this.input_nombre_producto.setText( pro.getNombre() );
                    encontrado = true;
